! function (t, e) {
    ...
    return function (t) {
        ...
        function u(t) {
            ...
            console.log("测试R", t, r.substr(0, r.indexOf("?")));
        ...
        e.byteLength = function (t) {
            ...
            for (var e, r = t.length, o = r % 3, i = [], s = 0, a = r - o; s < a; s += 16383) i.push(u(t, s, s + 16383 > a ? a : s + 16383));
        ...
        ! function () {
            ...
            e.encode = function (e) {
                ...
                var u = new ArrayBuffer(a),
                    f = new Uint8Array(u);
                for (e = 0; e < c; e += 4) n = r[t.charCodeAt(e)], o = r[t.charCodeAt(e + 1)], i = r[t.charCodeAt(e + 2)], s = r[t.charCodeAt(e + 3)], f[h++] = n << 2 | o >> 4, f[h++] = (15 & o) << 4 | i >> 2, f[h++] = (3 & i) << 6 | 63 & s;
                return u
            }
        }()
    }, function (t, e) {
        ...
        class f extends n {
            constructor(t, e, r) {
                super(), c("constructor: ", t, e, r), this.readyState = f.CONNECTING, this.protocol = "", this._closeCode = 1006, this._closeMessage = "", this._binaryType = h[0], this._socket = null, this.supports = {
                    binary: !0
                }, null !== t && (this._bufferedAmount = 0, this._redirects = 0, "object" == typeof e && null !== e && (r = e, e = void 0), function (t, e, r, n) {
                    const o = {
            ...
            setSocket(t, e) {
                this._socket = t, this._sender = new a(t), c("set socket: socket =", t, ", head =", e, ", this: ", this), this._socket.onOpen(t => {
        ...
        function f(t, e, r, n) {
            var o, i, s, a;
            if (h(r), void 0 === (i = t._events) ? (i = t._events = Object.create(null), t._eventsCount = 0) : (void 0 !== i.newListener && (t.emit("newListener", e, r.listener ? r.listener : r), i = t._events), s = i[e]), void 0 === s) s = i[e] = r, ++t._eventsCount;
            else if ("function" == typeof s ? s = i[e] = n ? [r, s] : [s, r] : n ? s.unshift(r) : s.push(r), (o = u(t)) > 0 && s.length > o && !s.warned) {
                s.warned = !0;
        ...
        i.prototype.parse = function (t, e, r) {
            ...
            for (var B = _.slice(-1)[0], S = (r.host || t.host || _.length > 1) && ("." === B || ".." === B) || "" === B, C = 0, R = _.length; R >= 0; R--) "." === (B = _[R]) ? _.splice(R, 1) : ".." === B ? (_.splice(R, 1), C++) : C && (_.splice(R, 1), C--);
            if (!A && !k)
                for (; C--; C) _.unshift("..");
            ...
            ! function (i) {
                ...
                function k(t) {
                    var e, r, n, o, i, s, a, h, u, f, p, d = [],
                        ...
                        m = 128,
                        w = 72;
                    for ((r = t.lastIndexOf("-")) < 0 && (r = 0), n = 0; n < r; ++n) t.charCodeAt(n) >= 128 && y("not-basic"), d.push(t.charCodeAt(n));
                    for (o = r > 0 ? r + 1 : 0; o < g;) {
                        for (i = v, s = 1, a = 36; o >= g && y("invalid-input"), ((h = (p = t.charCodeAt(o++)) - 48 < 10 ? p - 22 : p - 65 < 26 ? p - 65 : p - 97 < 26 ? p - 97 : 36) >= 36 || h > l((c - v) / s)) && y("overflow"), v += h * s, !(h < (u = a <= w ? 1 : a >= w + 26 ? 26 : a - w)); a += 36) s > l(c / (f = 36 - u)) && y("overflow"), s *= f;
                    ...
                    for (n = o = _.length, o && _.push("-"); n < g;) {
                        ...
                        for (a - e > l((c - r) / (v = n + 1)) && y("overflow"), r += (a - e) * v, e = a, s = 0; s < g; ++s)
                            if ((p = t[s]) < e && ++r > c && y("overflow"), p == e) {
                                for (h = r, u = 36; !(h < (f = u <= i ? 1 : u >= i + 26 ? 26 : u - i)); u += 36) k = h - f, b = 36 - f, _.push(d(w(f + k % b, 0))), h = l(k / b);
